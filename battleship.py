...
while while_turn == 1 :
	...
	while turn_player == 20:#choose which ship it is
		...
		if ship1_one_direc == 1:
			...
			if two_sec_ship1_col > 9 or three_sec_ship1_col > 9 or four_sec_ship1_col > 9 or five_sec_ship1_col > 9:
				...
				turn_player = 21
				break
		elif ship1_one_direc == 3: # south/down
			one_sec_ship1_row = ship1_row
			one_sec_ship1_col = ship1_col
			two_sec_ship1_row = ship1_row + 1  #makes it the number above for each row another cordinate to symbolize going north or up
			two_sec_ship1_col = ship1_col
			...
			if two_sec_ship1_row > 9 or three_sec_ship1_row > 9 or four_sec_ship1_row > 9 or five_sec_ship1_row > 9:
				...
				turn_player = 21
				break
		elif ship1_one_direc == 4: #west/left
			one_sec_ship1_row = ship1_row
			one_sec_ship1_col = ship1_col
			two_sec_ship1_row = ship1_row
			two_sec_ship1_col = ship1_col - 1
	...
	while turn_player == 13:
		ship2_row2 = random_row(board)
		ship2_col2 = random_col(board)
		ship2_two_direc =randint(1,4)
		turn_player = 23
		break
	...
	while turn_player == 15:
		ship3_row2 = random_row(board)
		ship3_col2 = random_col(board)
	...
	while turn_player == 0: # Decides the location of player 1's ship's second component
		if ship4_one_direc == 1: # north
			...
			if (one_sec_ship4_row == one_sec_ship1_row and one_sec_ship4_col == one_sec_ship1_col) or (one_sec_ship4_row == two_sec_ship1_row and one_sec_ship4_col == two_sec_ship1_col) or (one_sec_ship4_row == three_sec_ship1_row and one_sec_ship4_col == three_sec_ship1_col) or (one_sec_ship4_row == four_sec_ship1_row and one_sec_ship4_col == four_sec_ship1_col) or (one_sec_ship4_row == five_sec_ship1_row and one_sec_ship4_col == five_sec_ship1_col) or (one_sec_ship4_row == one_sec_ship2_row and one_sec_ship4_col == one_sec_ship2_col) or (one_sec_ship4_row == two_sec_ship2_row and one_sec_ship4_col == two_sec_ship2_col) or (one_sec_ship4_row == three_sec_ship2_row and one_sec_ship4_col == three_sec_ship2_col) or (one_sec_ship4_row == four_sec_ship2_row and one_sec_ship4_col == four_sec_ship2_col) or (one_sec_ship4_row == one_sec_ship3_row and one_sec_ship4_col == one_sec_ship3_col) or (one_sec_ship4_row == two_sec_ship3_row and one_sec_ship4_col == two_sec_ship3_col) or (one_sec_ship4_row == three_sec_ship3_row and one_sec_ship4_col == three_sec_ship3_col) or (two_sec_ship4_row == one_sec_ship1_row and two_sec_ship4_col == one_sec_ship1_col) or (two_sec_ship4_row == two_sec_ship1_row and two_sec_ship4_col == two_sec_ship1_col) or (two_sec_ship4_row == three_sec_ship1_row and two_sec_ship4_col == three_sec_ship1_col) or (two_sec_ship4_row == four_sec_ship1_row and two_sec_ship4_col == four_sec_ship1_col) or (two_sec_ship4_row == five_sec_ship1_row and two_sec_ship4_col == five_sec_ship1_col) or (two_sec_ship4_row == one_sec_ship2_row and two_sec_ship4_col == one_sec_ship2_col) or (two_sec_ship4_row == two_sec_ship2_row and two_sec_ship4_col == two_sec_ship2_col) or (two_sec_ship4_row == three_sec_ship2_row and two_sec_ship4_col == three_sec_ship2_col) or (two_sec_ship4_row == four_sec_ship2_row and two_sec_ship4_col == four_sec_ship2_col) or (two_sec_ship4_row == one_sec_ship3_row and two_sec_ship4_col == one_sec_ship3_col) or (two_sec_ship4_row == two_sec_ship3_row and two_sec_ship4_col == two_sec_ship3_col) or (two_sec_ship4_row == three_sec_ship3_row and two_sec_ship4_col == three_sec_ship3_col):
				turn_player = 16
			else: # If the row selected is inside of the bounds...
	...
	while turn_player == 17:
		ship4_row2 = random_row(board)
		ship4_col2 = random_col(board)
		ship4_two_direc = randint(1,4)
		turn_player = 1
	...
	while turn_player == 1: # The same as above, but for ship 2
		if ship4_two_direc == 1:
			...
			if (one_sec_ship4_row2 == one_sec_ship1_row2 and one_sec_ship4_col2 == one_sec_ship1_col2) or (one_sec_ship4_row2 == two_sec_ship1_row2 and one_sec_ship4_col2 == two_sec_ship1_col2) or (one_sec_ship4_row2 == three_sec_ship1_row2 and one_sec_ship4_col2 == three_sec_ship1_col2) or (one_sec_ship4_row2 == four_sec_ship1_row2 and one_sec_ship4_col2 == four_sec_ship1_col2) or (one_sec_ship4_row2 == five_sec_ship1_row2 and one_sec_ship4_col2 == five_sec_ship1_col2) or (one_sec_ship4_row2 == one_sec_ship2_row2 and one_sec_ship4_col2 == one_sec_ship2_col2) or (one_sec_ship4_row2 == two_sec_ship2_row2 and one_sec_ship4_col2 == two_sec_ship2_col2) or (one_sec_ship4_row2 == three_sec_ship2_row2 and one_sec_ship4_col2 == three_sec_ship2_col2) or (one_sec_ship4_row2 == four_sec_ship2_row2 and one_sec_ship4_col2 == four_sec_ship2_col2) or (one_sec_ship4_row2 == one_sec_ship3_row2 and one_sec_ship4_col2 == one_sec_ship3_col2) or (one_sec_ship4_row2 == two_sec_ship3_row2 and one_sec_ship4_col2 == two_sec_ship3_col2) or (one_sec_ship4_row2 == three_sec_ship3_row2 and one_sec_ship4_col2 == three_sec_ship3_col2) or (two_sec_ship4_row2 == one_sec_ship1_row2 and two_sec_ship4_col2 == one_sec_ship1_col2) or (two_sec_ship4_row2 == two_sec_ship1_row2 and two_sec_ship4_col2 == two_sec_ship1_col2) or (two_sec_ship4_row2 == three_sec_ship1_row2 and two_sec_ship4_col2 == three_sec_ship1_col2) or (two_sec_ship4_row2 == four_sec_ship1_row2 and two_sec_ship4_col2 == four_sec_ship1_col2) or (two_sec_ship4_row2 == five_sec_ship1_row2 and two_sec_ship4_col2 == five_sec_ship1_col2) or (two_sec_ship4_row2 == one_sec_ship2_row2 and two_sec_ship4_col2 == one_sec_ship2_col2) or (two_sec_ship4_row2 == two_sec_ship2_row2 and two_sec_ship4_col2 == two_sec_ship2_col2) or (two_sec_ship4_row2 == three_sec_ship2_row2 and two_sec_ship4_col2 == three_sec_ship2_col2) or (two_sec_ship4_row2 == four_sec_ship2_row2 and two_sec_ship4_col2 == four_sec_ship2_col2) or (two_sec_ship4_row2 == one_sec_ship3_row2 and two_sec_ship4_col2 == one_sec_ship3_col2) or (two_sec_ship4_row2 == two_sec_ship3_row2 and two_sec_ship4_col2 == two_sec_ship3_col2) or (two_sec_ship4_row2 == three_sec_ship3_row2 and two_sec_ship4_col2 == three_sec_ship3_col2):
				turn_player = 17
			else:
				while_turn = 2
				turn_player = 2
